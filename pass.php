...
<body>
	...
	<div class="d-flex" id="wrapper">
		...
		<div class="bg-maroon border-right" id="sidebar-wrapper">
			<div class="sidebar-heading" style="text-align: center; color: white;font-size: 28px;display: inline-block;">STUDENT</div>
			<div class="list-group list-group-flush" id="link" style="margin-top: 22px;">
				...
				<a href="#" class="list-group-item list-group-item-action bg-light">LECTURERS</a>
  ...
  //get the page's url
          ...
          ?>
						<div style="border-radius: 10%; border:5px solid skyblue; background-color: azure; ">
							<form action="changepass.php" method="POST" class="form-group" style="padding: 30px;" >
